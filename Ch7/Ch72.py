...
theta=0.0
R=1.0
scene = canvas(title='Spring Wave', width=1200, height=300, range = 0.4*50/6, center = vector(0,(N-1)*d/2, 0)) 
...
while True:
    ...
    ball[0].pos = vector(R*cos(theta), 0,R*sin(theta))
    #在球與球之間放入彈簧
