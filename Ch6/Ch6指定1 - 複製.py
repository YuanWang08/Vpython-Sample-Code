...
while True:
    ...
    ball_m2_v += (Fg_12_vector+Fg_23_vector)/m2*dt
    ...
    if pre_m1m2_rv.x > pre_pre_m1m2_rv.x and pre_m1m2_rv.x >  radiavector_12.x and t>2414599:
        earth_T = t1/86400.0 #設定earth_T為地球週期
        print ('earth_t=' , '%1.2f'%earth_T)
        t1=0 #時間重置

    #找月球相對地球右端點位置
    if pre_m2m3_rv.x > pre_pre_m2m3_rv.x and pre_m2m3_rv.x >  radiavector_23.x and t>2414599:
        moon_T = t2/86400.0                                                                                                                                                                                                                                                                                                                                                                                                                       ;moon_T=moon_T-2
        print ('moon_T=' , '%1.2f'%moon_T)
        t2=0 

    #找月球
    if mag(pre_m1m2_rv-pre_m2m3_rv) > mag(pre_pre_m1m2_rv-pre_pre_m2m3_rv) and mag(pre_m1m2_rv-pre_m2m3_rv) >  mag(radiavector_12-radiavector_23)and t>2414599 :
        moon_T2 = t3/86400.0                                                                                                                                                                                                                                                                                                                                                                                                                            ;moon_T2=moon_T2-2
